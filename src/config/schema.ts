...
export const AgentFSConfigSchema = z.object({
	dbPath: z.string().default(".agentfs/").describe("Directory for AgentFS SQLite databases"),

	mountPath: z.string().default("~/.agentfs/mounts/").describe("Base directory for FUSE mounts"),

	autoMount: z.boolean().default(true).describe("Automatically mount overlay on session create"),
